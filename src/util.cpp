...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "GeroCoin.conf"));
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good())
        return; // No GeroCoin.conf file is OK
    ...
    {
        // Don't overwrite existing settings so command line settings override GeroCoin.conf
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "GeroCoin.pid"));
