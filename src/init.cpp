    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("FooCoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  GeroCoin [options]                     " + "\n" +
                  "  GeroCoin [options] <command> [params]  " + _("Send command to -server or GeroCoin") + "\n" +
                  "  GeroCoin [options] help                " + _("List commands") + "\n" +
                  "  GeroCoin [options] help <command>      " + _("Get help for a command") + "\n";
        ...
        for (int i = 1; i < argc; i++)
            if (!IsSwitchChar(argv[i][0]) && !boost::algorithm::istarts_with(argv[i], "GeroCoin:"))
                fCommandLine = true;
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: GeroCoin.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: GeroCoin.pid)") + "\n" +
...
//    }
    ...
    // Make sure only a single GeroCoin process is using the data directory.
    ...
    // requested to kill GeroCoin-qt during the last operation. If so, exit.
